...
function updateHtmlHall(serverResponse) {
    ...
    const textHtmlLegend = `
        <div class='conf-step__legend'>
            <div class='col'>
                <p class='conf-step__legend-price'><span class='conf-step__chair conf-step__chair_standart'></span> Свободно (<span class='conf-step__legend-value price-standart'>${dataOfTheSelectedSeance.priceStandart}</span>руб)</p>
                <p class='conf-step__legend-price'><span class='conf-step__chair conf-step__chair_vip'></span> Свободно VIP (<span class='conf-step__legend-value price-vip'>${dataOfTheSelectedSeance.priceVip}</span>руб)</p> 
            </div>
            <div class='col'>
